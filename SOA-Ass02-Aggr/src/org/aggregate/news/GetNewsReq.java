...
/**
 * GetNewsReq bean class
 */

public class GetNewsReq implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://news.aggregate.org/", "getNewsReq", "ns1");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":getNewsReq", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"getNewsReq", xmlWriter);
			}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		elementList.add(new javax.xml.namespace.QName("", "feed"));

		if (localFeed != null) {
			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localFeed));
		} else {
			throw new org.apache.axis2.databinding.ADBException(
					"feed cannot be null!!");
		}
		if (localAuthorTracker) {
			elementList.add(new javax.xml.namespace.QName("", "author"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetNewsReq parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GetNewsReq object = new GetNewsReq();
			...
			try {
						...
						if (!"getNewsReq".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (GetNewsReq) org.aggregate.news.ExtensionMapper
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						...
						if (reader.isStartElement()
								&& new javax.xml.namespace.QName("", "feed")
										.equals(reader.getName())) {

							java.lang.String content = reader.getElementText();

							object
									.setFeed(org.apache.axis2.databinding.utils.ConverterUtil
						...
						if (reader.isStartElement()
							...
							object
									.setCategory(org.apache.axis2.databinding.utils.ConverterUtil
											.convertToString(content));
